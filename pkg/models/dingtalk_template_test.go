...
func TestDingtalkDetailSeparatesAlerts(t *testing.T) {
	...
	first := strings.Index(detail, `> **Instance**: <font color="#722ED1">10.30.1.160</font>`)
	second := strings.Index(detail, `> **Instance**: <font color="#722ED1">10.30.1.162</font>`)
	if first < 0 || second < 0 {
	...
	if strings.Contains(gap, "**Instance**:  \n<font") {
